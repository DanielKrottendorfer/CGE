...
void VSShaderLib::loadShader(VSShaderLib::ShaderType st, std::string fileName)
{
...
void VSShaderLib::prepareProgram()
{
...
void VSShaderLib::setProgramOutput(int index, std::string name)
{

	glBindFragDataLocation(pProgram, index, name.c_str());
}

GLint VSShaderLib::getProgramOutput(std::string name)
{

	return glGetFragDataLocation(pProgram, name.c_str());
}

void VSShaderLib::setVertexAttribName(VSShaderLib::AttribType at, std::string name)
{
...
void VSShaderLib::setBlock(std::string name, void *value)
{
...
void VSShaderLib::setBlockUniform(std::string blockName,
...
void VSShaderLib::setBlockUniformArrayElement(std::string blockName,
											  std::string uniformName,
											  int arrayIndex,
											  void *value)
{
...
void VSShaderLib::setUniform(std::string name, int value)
{
...
void VSShaderLib::setUniform(std::string name, float value)
{
...
void VSShaderLib::setUniform(std::string name, void *value)
{
...
bool VSShaderLib::isProgramValid()
{
...
bool VSShaderLib::isProgramLinked()
{
...
void VSShaderLib::addUniform(std::string name, GLenum type, unsigned int size)
{
...
int VSShaderLib::typeSize(int type)
{
