...
VSMathLib::VSMathLib() : mInit(false),
						 mBlocks(false)
{
...
void VSMathLib::setUniformBlockName(std::string blockName)
{
...
void VSMathLib::setUniformName(MatrixTypes matType, std::string uniformName)
{
...
void VSMathLib::setUniformName(ComputedMatrixTypes matType, std::string uniformName)
{
...
void VSMathLib::setUniformArrayIndexName(MatrixTypes matType,
...
void VSMathLib::setUniformArrayIndexName(ComputedMatrixTypes matType,
										 std::string uniformName, int index)
{
...
void VSMathLib::pushMatrix(MatrixTypes aType)
{
...
void VSMathLib::popMatrix(MatrixTypes aType)
{
...
void VSMathLib::loadIdentity(MatrixTypes aType)
{
	setIdentityMatrix(mMatrix[aType]);
}

// glMultMatrix implementation
void VSMathLib::multMatrix(MatrixTypes aType, float *aMatrix)
{
...
void VSMathLib::loadMatrix(MatrixTypes aType, float *aMatrix)
{
	memcpy(mMatrix[aType], aMatrix, 16 * sizeof(float));
}

// glTranslate implementation with matrix selection
void VSMathLib::translate(MatrixTypes aType, float x, float y, float z)
{
	float mat[16];
...
void VSMathLib::translate(float x, float y, float z)
{
	translate(MODEL, x, y, z);
}

// glScale implementation with matrix selection
void VSMathLib::scale(MatrixTypes aType, float x, float y, float z)
{
	float mat[16];
...
void VSMathLib::scale(float x, float y, float z)
{
	scale(MODEL, x, y, z);
}

// glRotate implementation with matrix selection
void VSMathLib::rotate(MatrixTypes aType, float angle, float x, float y, float z)
{
	float mat[16];
...
void VSMathLib::rotate(float angle, float x, float y, float z)
{
	rotate(MODEL, angle, x, y, z);
}

// gluLookAt implementation
void VSMathLib::lookAt(float xPos, float yPos, float zPos,
...
void VSMathLib::perspective(float fov, float ratio, float nearp, float farp)
{
	float projMatrix[16];
...
void VSMathLib::ortho(float left, float right,
...
void VSMathLib::frustum(float left, float right,
						float bottom, float top,
						float nearp, float farp)
{
	float m[16];
...
// universal
void VSMathLib::matrixToGL(MatrixTypes aType)
{
	if (mInit)
	{
...
void VSMathLib::matrixToGL(ComputedMatrixTypes aType)
{
	if (mInit)
	{
...
void VSMathLib::setIdentityMatrix(float *mat, int size)
{
...
// Compute res = M * point
void VSMathLib::multMatrixPoint(MatrixTypes aType, float *point, float *res)
{
...
// Compute res = M * point
void VSMathLib::multMatrixPoint(ComputedMatrixTypes aType, float *point, float *res)
{
...
// res = a cross b;
void VSMathLib::crossProduct(float *a, float *b, float *res)
{
...
// returns a . b
float VSMathLib::dotProduct(float *a, float *b)
{
...
// Normalize a vec3
void VSMathLib::normalize(float *a)
{
...
// res = a - b
void VSMathLib::subtract(float *a, float *b, float *res)
{
...
// res = a + b
void VSMathLib::add(float *a, float *b, float *res)
{
...
// returns |a|
float VSMathLib::length(float *a)
{
...
void VSMathLib::computeNormalMatrix()
{
...
void VSMathLib::computeNormalViewMatrix()
{
...
void VSMathLib::computeNormalModelMatrix()
{
...
// computes the derived normal matrix
void VSMathLib::computeNormalMatrix3x3()
{
...
void VSMathLib::computeNormalViewMatrix3x3()
{
...
void VSMathLib::computeNormalModelMatrix3x3()
{
...
void VSMathLib::computeDerivedMatrix(ComputedMatrixTypes aType)
{
...
void VSMathLib::multMatrix(float *resMat, float *aMatrix)
{
